...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Initialize Parse.
        Parse.setApplicationId("WxXXZ5D7M1OJL9JsRfe9PVTXgXdn5xcS4YHx88Ma",
            clientKey: "zyRgaqaSFZUMD8Zz76mEZTQs6qia5yt4MlZuEGYV")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Yep.CoreDataExample" in the application's documents Application Support directory.
